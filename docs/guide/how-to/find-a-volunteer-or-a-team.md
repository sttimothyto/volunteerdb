# Find a volunteer or a team

Find a person or a team by name, from the *Dashboard* or from the lists.

## Before you start

- You are signed in.
- The search finds every volunteer by name. It finds an email address, a phone number or a note only where you can see those details.
- The search finds a team by its name, its description, or the name of its parent team.
...
6. Click a volunteer to open their side panel.
7. To see every match, click *See every match for* followed by your text, or press Enter.

## What you see

- The list shows up to 6 teams and 6 volunteers. If nothing matches, it says *Nothing found*.
- Enter, or the button *Search*, opens the *Volunteers* page with every match in a table.
...
- Technical detail: [Search query filters](../../reference/query-language.md)
