...
def deploy_app(site, secrets, *, here, repo_root, unit_vars, admin_password) -> None:
    ...
    files.template(
        ...
        sheets_folder_id=secrets.sheets_folder_id,
        ...
        roster_sync_at=site.schedule_roster_sync_at,
